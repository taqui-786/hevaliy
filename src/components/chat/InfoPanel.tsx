...
const SessionCard = ({
  ...
  <div
    className={`p-4 rounded-xl ${
      isNext
        ? "bg-[#FEF6D4] border border-orange-200"
        : "bg-[#DFFFDA] border border-green-200"
    }`}
  >
    <div className="flex gap-2 mb-2 text-sm text-gray-600">
      ...
      <div>
        <span className="text-[13px] text-gray">
          {isNext ? "Next Session" : "Upcoming Session"}
        </span>
...
export default function InfoPanel() {
  ...
  return (
    <div className="w-full bg-white h-full flex flex-col border-l-0 md:border-l md:border-gray-100">
      {/* Panel Header */}
      <div
        className={`${nunito.className}  p-3 items-center justify-between border-b-2 border-gray-100 pb-4 mb-6 shrink-0 lg:flex hidden`}
      >
      ...
      <div className="text-center mb-8">
        ...
        <p className={`${nunito.className} font-bold text-lg`}>
          {selectedUser?.name}
        </p>
        <p
