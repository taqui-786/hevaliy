  ...
  return (
    <Link
      ...
      className={`flex items-center justify-between px-3 py-2 rounded-lg transition ${
        isActive ? 'bg-[#EFF6FF] text-[#165DFC] text-sm' : 'text-gray-500 hover:bg-[#EFF6FF]'
      } lg:justify-start`}
    >
...
export default function Sidebar({ isResponsive }: { isResponsive?: boolean }) {
  return (
    <aside className="bg-white p-9 flex flex-col h-full sticky top-0 self-start">
      <div className="mb-52">
        <h3 className={`${nunito.className} text-[11px] text-gray font-extrabold mb-3 hidden lg:block`}>
          Main Menu
        </h3>
      ...
      <div className="pt-4 border-t border-gray-200">
        <div className="px-3 py-5 bg-[#F5F5FF] rounded-lg hidden lg:block" style={{ fontFamily: "Arial" }}>
